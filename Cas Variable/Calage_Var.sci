...
disp(nT,'le nombre d observation DayAhead');
...
//2: Calage par EMV
Theta_EMV = Calage_Xt_Var(n,h,Xt_obs,X0,lnFt_obs,lnF0);
disp(Theta_EMV,'Les parametres : lambda, sigma par EMV variable Day-Ahead');


//3: autocorrelation des residus et test de box-pierce
alpha = 0.05;
[Resid, Autocorr, BP_Test, Probac, JB_Test, S, K, Proban] = Residu_Var(n,h,Theta_EMV,Xt_obs,X0,lnFt_obs,lnF0,alpha);
